...
class PDF(FPDF):
    def header(self):
        if self.page_no() == 1:
            ...
            # Definição do preenchimento cinza claro para as informações superiores
...
def gerar_pdf_comparacao(dados_comparacao, observacao):
    ...
    # Cor padrão para o cabeçalho das tabelas em todo o PDF
    ...
    for idx, ano_data in enumerate(dados_comparacao):
        ...
        # Cabeçalhos com fundo cinza (fill=True)
