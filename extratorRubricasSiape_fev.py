...
def gerar_excel(df_filtrado, metadados):
    ...
    df_filtrado["Competencia"] = pd.to_datetime(df_filtrado["Competencia"])

    consolidado = df_filtrado.groupby(
        ["Ano","Discriminacao"]
...
with abas[1]:
    ...
    if 'df_filtrado' in locals() and not df_filtrado.empty:
        ...
        fig = px.bar(
            ...
            color="Discriminacao",
            barmode="group",
            title="Valores por Rubrica e Ano"
        )
